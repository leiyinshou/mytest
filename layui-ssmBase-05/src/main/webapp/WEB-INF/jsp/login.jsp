...
<div class="qiqiu1 qiqiu">
    <img src="http://qt4k1ztnj.hn-bkt.clouddn.com/q2.png" />
    <div class="text">小型进销存系统</div>
</div>
<div class="qiqiu2 qiqiu">
    <img src="http://qt4k1ztnj.hn-bkt.clouddn.com/q3.png" />
    <div class="text">小型进销存系统</div>
</div>
<div class="qiqiu3 qiqiu">
    <img src="http://qt4k1ztnj.hn-bkt.clouddn.com/q4.png" />
    <div class="text">小型进销存系统</div>
</div>
<div class="qiqiu4 qiqiu">
    <img src="http://qt4k1ztnj.hn-bkt.clouddn.com/q5.png" />
    <div class="text">小型进销存系统</div>
</div>
<div class="qiqiu5 qiqiu">
    <img src="http://qt4k1ztnj.hn-bkt.clouddn.com/q6.png" />
    <div class="text">小型进销存系统</div>
</div>
...
<div class="login" style="height: 300px;">
    ...
    <form class="layui-form" action="" lay-filter="example">
        ...
        <div class="layui-form-item">
            <input id="password" class="layui-input" name="password" placeholder="密码"
