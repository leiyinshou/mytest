...
<div class="layui-layout layui-layout-admin">
	<div class="layui-header">
		...
		<ul class="layui-nav layui-layout-right">
			...
			<li class="layui-nav-item">
				<span class="hp-kd" style="color: red">${loginUser.realname }</span>
			</li>
			<li class="layui-nav-item">
			...
			<ul class="layui-nav hp-nav-none">
				<li class="layui-nav-item">
					<a href="javascript:;"  class="hp-user-name">
						...
						<span class="hp-kd">${loginUser.realname }</span>
					</a>
					<dl class="layui-nav-child">
						<dd>
			...
			<ul class="layui-nav layui-nav-tree" lay-filter="test">
				<li class="layui-nav-item">
					...
					<dl class="layui-nav-child" style="padding-left: 15px">
						<dd>
							<a class="hp-tab-add" hp-href="model/toSaveSale" href="javascript:;" >销售</a>
						</dd>
						<dd>
						...
						<dd>
							<a class="hp-tab-add" hp-href="model/toSelProduct" href="javascript:;" >查看库存</a>
						</dd>
					</dl>
				</li>
			</ul>
						...
						<div carousel-item style="height: 750px;">
							<div>
								<div class="layui-bg-green demo-carousel">
									...
									<p style="font-size: 28px;">${loginUser.realname }</p>
								</div>
							</div>
							<div>
